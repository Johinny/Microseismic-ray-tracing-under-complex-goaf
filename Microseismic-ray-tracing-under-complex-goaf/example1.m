...
data=[];V=4000;
%% 空区1  mian DD Y PD
mian=load('单空区模型mian.txt');
DD=load('单双空区模型dd.txt');
% Y=load('C:\Users\Administrator\Desktop\大论文（考虑工程地质的微震精确定位）\射线追踪\点云射线追踪\模型文件\y.txt');
...
%% 
[data]=Travetime(data,DD,V,Snum,Y,PD,Jmin);

[rays]=Raytracing(data,received);
